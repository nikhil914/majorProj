...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(InputScreen.minmin,"Min Min Execution Time","Min Min Execution Time");
	localDefaultCategoryDataset.addValue(InputScreen.maxmin,"Max Min Execution Time","Max Min Execution Time");
	localDefaultCategoryDataset.addValue(InputScreen.ptct,"PTCT Execution Time","PTCT Execution Time");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Algorithm Name", "Makespan Execution Time (Milli.sec)", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
